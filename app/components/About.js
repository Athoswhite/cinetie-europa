          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <span className="text-purple-500 block mb-2 text-lg font-semibold text-primary">
                Entertain Europe Through{" "}
                </span>
                <h1 className=" md:text-6xl font-bold text-white mb-8">
            
            <span className="text-white">African Cinema</span>
          </h1>
          <div className="mt-8">
            <a
              href="https://www.cinetie.com"
              className="p-4 btn bg-red-800 text-white  border-red btn btn-animated"
              target="_blank"
