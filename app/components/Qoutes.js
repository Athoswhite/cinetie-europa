...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full clearNav z-50">
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-wrap p-5 flex-col md:flex-row justify-between">
          <div className="flex flex-row items-center p-3 md:p-1">
            <a
              href="/"
              className="flex text-3xl text-red-700 font-medium mb-4 md:mb-0"
            >
              CINETIE
            </a>
            <button
          ...
          <div
            ...
            } md:flex items-center md:pl-14 pl-1`}
          >
            ...
            <div className="md:flex items-center md:pl-4 mt-4 md:mt-0">
              ...
              >
                <img
                  src="https://th.bing.com/th/id/R.6d1be50b5afefee4fb715a3d9bf9dbb7?rik=hD4QBFBVvBv6bg&riu=http%3a%2f%2fvideodashboard.io%2fspecial%2fassets%2fimages%2fs18-pic3.png&ehk=ZEX2NUXqk5ZU25k7wRH%2bgNyQaI6KEFXSiGqam%2bxk8Jk%3d&risl=&pid=ImgRaw&r=0"
                  alt="TikTok Logo"
                  className="h-6"
                />
              </a>
